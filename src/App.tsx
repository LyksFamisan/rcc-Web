...
const androidArtwork = assetUrl('android.png')
const flutterArtwork = assetUrl('flutter.png')
const iosArtwork = assetUrl('ios.png')
const reactArtwork = assetUrl('react.png')
const angularArtwork = assetUrl('angular.png')
const htmlCssArtwork = assetUrl('html-css.png')
const graphArtwork = assetUrl('graph.png')
const javaArtwork = assetUrl('java.png')
const nodeArtwork = assetUrl('node.png')
const scalaArtwork = assetUrl('scala.png')
const sparkArtwork = assetUrl('spark.png')
const springArtwork = assetUrl('spring.png')
const appianArtwork = assetUrl('appian.png')
const clarisArtwork = assetUrl('claris.png')
const adobeArtwork = assetUrl('adobe.png')
const krakenDArtwork = assetUrl('krakenD.png')
const hakuraArtwork = assetUrl('hakura.png')
const kongArtwork = assetUrl('kong.png')
const apigeeArtwork = assetUrl('apigee.png')
const amazonApiArtwork = assetUrl('amazonapi.png')
const tykArtwork = assetUrl('tyk.png')
const seleniumArtwork = assetUrl('selenium.png')
const testNgArtwork = assetUrl('testng.png')
const pytestArtwork = assetUrl('pytest.png')
const mavenArtwork = assetUrl('maven.png')
const openShiftArtwork = assetUrl('openshift.png')
const gitLabArtwork = assetUrl('gitlab.png')
const sonarArtwork = assetUrl('sonarqube.png')
const jenkinsArtwork = assetUrl('jenkins.png')
